...
If an issue is underlined that denotes that the issue was introduced by the latest version of the patch.
...
GameGlitch-005:: +++<ins>+++Pillarboxes and letterboxes drawn by the patch are sometimes not drawn when they should be, such as in 2D areas of the game's town.+++</ins>+++
